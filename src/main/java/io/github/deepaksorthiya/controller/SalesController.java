package io.github.deepaksorthiya.controller;

import io.github.deepaksorthiya.dto.*;
import io.github.deepaksorthiya.exceptions.EntityNotFoundException;
import io.github.deepaksorthiya.model.Sales;
import io.github.deepaksorthiya.service.SalesService;
...
public class SalesController {
    ...
    public SalesDTO postSale(@RequestBody SalesDTO SalesDTO) {
    ...
    public List<PopularDTO> findPopularItems() {
        return salesService.findPopularItems();
    }
    ...
    public List<BucketsDTO> findTotalSpend() {
        return salesService.findTotalSpend();
    }
