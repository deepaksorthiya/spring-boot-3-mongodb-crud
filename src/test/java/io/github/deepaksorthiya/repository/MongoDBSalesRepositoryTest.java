...
import io.github.deepaksorthiya.dto.TotalSalesDTO;
import io.github.deepaksorthiya.model.Customer;
import io.github.deepaksorthiya.model.Item;
...
@Testcontainers
@SpringBootTest
class MongoDBSalesRepositoryTest {
    @Container
    public static MongoDBContainer mongoDBContainer = new MongoDBContainer(DockerImageName.parse("mongo:8.0.3"));
    ...
    static void setProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.data.mongodb.database", () -> "sample_supplies");
    }
    ...
    public void testTotalSales() {
        List<TotalSalesDTO> totalSales = salesRepository.TotalSales();
        assertThat(totalSales).isNotEmpty();
        assertThat(totalSales.size()).isGreaterThan(0);
    }
}
